...
const finishOrderStage = (str, time) => {
...
finishOrderStage("1. Finished browsing Amazon.de...", 4000)
.then(string => {
    console.log(string);
    return finishOrderStage("2. Finished ordering product...", 2000);
})
.then(string => {
    console.log(string);
    return finishOrderStage("3. Product has been sent...", 5000);
})
.then(string => {
    console.log(string);
    return finishOrderStage("4. Postman has arrived with the product...", 3000);
})
.then(string => {
    console.log(string);
    return finishOrderStage("5. Answered the door - product received!", 1000);
})
.then(string => {
    console.log(string);
});
